...
An example request that can be used to retrieve data from the Global Population
Density collection is
[here](https://labs.metoffice.gov.uk/edr/collections/global_pop_density/position?coords=POINT(-1.406%2054.157)&parameter-name=Pop_Density&crs=EPSG:4326&f=CoverageJSON)
