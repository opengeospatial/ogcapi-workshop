...
!!! abstract "Objetivos de Aprendizagem"
    Descreve o que os estudantes deverão ser capazes de fazer após a conclusão do módulo.
...
!!! note
    ...
    Destaca algum aspeto importante.
...
``` json
{
    "title": "título da minha coleção fantástica",
    "description": "descrição da minha coleção fantástica"
}
```
...
Para problemas/bugs/sugestões ou melhorias/contribuições, por favor utilize o [rastreador de issues no GitHub](https://github.com/opengeospatial/ogcapi-workshop/issues).
